...
class Gifts extends Component
{
    ...
    public function hideModel() {
        ...
        return redirect()->route('frontend.gifts');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.frontend.gifts', [
            'countries'     => $countries,
            'address'       => $this->getAddress(),
            'gifts'         => Gift::where('status','=',  0)->where('soft_deleted', '=', 0)->get(),
            'pageInfo'      => Page::where('slug', '=', 'gifts')->first(),
