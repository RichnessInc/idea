<div>
    ...
    <x-jet-dialog-modal wire:model="createFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-jet-label for='email' value="{{__('البريدالإلكتروني')}}" />
        ...
        <table class="w-full flex flex-row flex-no-wrap sm:bg-white sm:dark:bg-gray-900 rounded-lg overflow-hidden sm:shadow-lg my-5">
            ...
            <tbody class="flex-1 sm:flex-none">
                ...
                <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0 bg-white dark:bg-gray-900 mob-text-aline">
                    <td class="border-grey-light border dark:text-gray-300 dark:hover:bg-gray-800 hover:bg-gray-100 p-3">{{$row->client->name}}</td>
                    <td class="border-grey-light border dark:text-gray-300 dark:hover:bg-gray-800 hover:bg-gray-100 p-3">{{floor($row->value)}} ريال</td>
